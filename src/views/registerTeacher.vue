<template>
  <div class="crumbs">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item :to="{ path: '/admin/registerTeacher' }"
        >注册教师</el-breadcrumb-item
      >
    </el-breadcrumb>
  </div>
  <div class="box">
    <div class="left">
      ...
      >
        ...
        <el-form-item label="教师编号" prop="teacherID">
          <el-input v-model.number="form.teacherID" clearable />
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="handInsertForm()">注册</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="right">
...
<script>
import { registerTeachers } from "@/api/register";
    ...
    handInsertForm() {
      this.$refs["form"].validate((validate) => {
        if (validate) {
          ...
          registerTeachers(data).then((response) => {
